        ...
        return (
            <div className="book-item needsclick"  data-item_type={data.item_type} data-item_id={data.item_id} data-sku={data.sku_list[0].sku_no}>
                <div className="book-info">
                    <Link to={'/detail/'+data.item_id} className="book-img" href={data.url}>
                        <img className="lazy-img" data-url={data.cover_img.url} />
                    </Link>
                    <div className="book-intro">
                        <Link to={'/detail/'+data.item_id} className="book-name" href={data.url}>{data.item_name}</Link>
                        <Link to={'/detail/'+data.item_id} className="book-desc">{data.desc}</Link>
