...
class ListItemHandleBtn extends React.Component {
    ...
    render() {
        let tpl = <div>无</div>;
        if(this.state.data) {
            let status = this.state.data.status, data = this.state.data;
            switch (status) {
                case 'play':
                    tpl = <div
                        className={this.state.loading ? 'handle-btn handle-play-btn loading' : 'handle-btn handle-play-btn'}
                        onClick={this.handleClick.bind(this, this.state.data)} data-btn_status={this.state.data.status}
                        data-url_scheme={this.state.data.action && this.state.data.action.url ? this.state.data.action.url : ''}>
                ...
                case 'direct_pay':
                    tpl = <div
                        className={this.state.loading ? 'handle-btn handle-buy-btn loading' : 'handle-btn handle-buy-btn'}
                        onClick={this.handleClick.bind(this, this.state.data)} data-btn_status={this.state.data.status}
                        data-url_scheme={this.state.data.action && this.state.data.action.url ? this.state.data.action.url : ''}>
                ...
                case 'pass':
                    ...
                    break;
                case 'offshelf':
                    tpl = <div className="handle-btn handle-off-btn"
                               onClick={this.handleClick.bind(this, this.state.data)}
                               data-btn_status={this.state.data.status}
                               data-url_scheme={this.state.data.action && this.state.data.action.url ? this.state.data.action.url : ''}>
                ...
                case 'wish':
                    tpl = <div
                        className={this.state.loading ? 'handle-btn handle-reserve-btn loading' : 'handle-btn handle-reserve-btn'}
                        onClick={this.handleClick.bind(this, this.state.data)} data-btn_status={this.state.data.status}
                        data-url_scheme={this.state.data.action && this.state.data.action.url ? this.state.data.action.url : ''}>
                    ...
                    break;
                case 'wished':
                    tpl = <div className="handle-btn handle-reserve-btn reserved"
                               onClick={this.handleClick.bind(this, this.state.data)}
                               data-btn_status={this.state.data.status}
                               data-url_scheme={this.state.data.action && this.state.data.action.url ? this.state.data.action.url : ''}>
